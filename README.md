...
<p align="center">
  <a href="https://your-username.github.io/PhotoCrypt-NFT">🌐 在线演示</a> ·
  <a href="#-快速开始">⚡ 快速开始</a> ·
  <a href="#-技术架构">🏗️ 架构</a> ·
...
**点击直接访问**：👉 [https://your-username.github.io/PhotoCrypt-NFT](https://your-username.github.io/PhotoCrypt-NFT)
...
```bash
git clone https://github.com/your-username/PhotoCrypt-NFT.git
cd PhotoCrypt-NFT
```
